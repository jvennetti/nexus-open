(function(){
  ...
  document.addEventListener('visibilitychange',function(){
    if(!_isMobile) return;
    if(document.hidden){
      (window.__bgAudio||[]).forEach(function(a){if(a&&typeof a.pause==='function'&&!a.paused){a._pausedByViz=true;a.pause();}});
    } else {
      (window.__bgAudio||[]).forEach(function(a){if(a&&a._pausedByViz){a._pausedByViz=false;if(typeof a.play==='function')a.play().catch(function(){});}});
    }
  });
